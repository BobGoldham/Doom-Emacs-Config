# SPDX-FileCopyrightText © 2023-2025 BobGoldham <sold@sold.rip>
...
(setq doom-font (font-spec :family "Fantasque Sans Mono" :size 18)
      doom-big-font (font-spec :family "Fantasque Sans Mono" :size 27)
...
#+call: confpkg("!Pkg doc-view-mode")

I like being able to scroll continuously when viewing documents of any kind.
~doc-view-mode~ is the Emacs solution to viewing otherwise unsupported documents,
such as Word files. Hence I will enable continuous scrolling this mode.
...
#+begin_src emacs-lisp :tangle packages.el
(package! highlight-numbers :recipe (:host github :repo "Fanael/highlight-numbers"))
#+end_src
...
Similarly, it would be nice to have a partial derivative counterpart =\pdv= which
